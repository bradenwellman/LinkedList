...
// Everytime you add something to the list
// 1. Use new to create a new node
// 2. Put the data into that node
// 3. Put that node into the linked list


// USE THE BOOK
// USE THE VECTOR EXAMPLE